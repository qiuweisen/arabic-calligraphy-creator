              ...
              <TabsContent value="web">
                <Card className="border-amber-200 bg-white/80 backdrop-blur-sm">
                  <CardContent className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h3 className="text-lg font-bold text-amber-800 mb-3">Enhance Your Web Presence</h3>
                        <p className="text-amber-700 mb-4">
                          Add beautiful Arabic typography to your website, blog, or online store.
                        </p>
                        <ul className="space-y-2 text-amber-700">
                          <li className="flex items-start">
                            <Check className="h-4 w-4 text-amber-600 mr-2 mt-0.5" />
                          ...
                          <li className="flex items-start">
                            <Check className="h-4 w-4 text-amber-600 mr-2 mt-0.5" />
                            <span>Logos and branding elements</span>
                          </li>
                          <li className="flex items-start">
                            <Check className="h-4 w-4 text-amber-600 mr-2 mt-0.5" />
                          ...
                          <li className="flex items-start">
                            <Check className="h-4 w-4 text-amber-600 mr-2 mt-0.5" />
                            <span>Blog graphics and pull quotes</span>
                          </li>
                        </ul>
                      </div>
                      <div className="flex items-center justify-center">
              ...
              <TabsContent value="art">
                <Card className="border-amber-200 bg-white/80 backdrop-blur-sm">
                  <CardContent className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h3 className="text-lg font-bold text-amber-800 mb-3">Create Artistic Decorations</h3>
                        <p className="text-amber-700 mb-4">
                          Design wall art, home decor, and personalized gifts featuring Arabic calligraphy.
                        </p>
                        <ul className="space-y-2 text-amber-700">
                          <li className="flex items-start">
                            <Check className="h-4 w-4 text-amber-600 mr-2 mt-0.5" />
                            <span>Wall art and framed prints</span>
                          </li>
                          <li className="flex items-start">
                            <Check className="h-4 w-4 text-amber-600 mr-2 mt-0.5" />
                            <span>Custom gifts with Arabic phrases</span>
                          </li>
                          <li className="flex items-start">
                            <Check className="h-4 w-4 text-amber-600 mr-2 mt-0.5" />
                            <span>T-shirt and merchandise designs</span>
                          </li>
                          <li className="flex items-start">
                            <Check className="h-4 w-4 text-amber-600 mr-2 mt-0.5" />
                            <span>Digital wallpapers for devices</span>
                          </li>
                        </ul>
                      </div>
                      <div className="flex items-center justify-center">
