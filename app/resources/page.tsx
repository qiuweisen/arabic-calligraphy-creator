...
export const metadata: Metadata = {
  title: "Arabic Calligraphy Resources | Design Templates, Fonts & Inspiration",
  ...
  keywords: "arabic calligraphy resources, free arabic fonts, design templates, calligraphy inspiration",
}
