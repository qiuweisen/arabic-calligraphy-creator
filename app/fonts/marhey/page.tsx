...
const FONT_FEATURES = [
  {
    icon: <PlayCircle className="h-8 w-8 text-amber-700 mb-2" />,
  ...
  {
    icon: <Gift className="h-8 w-8 text-amber-700 mb-2" />,
  ...
  {
    icon: <Music2 className="h-8 w-8 text-amber-700 mb-2" />,
...
const IDEAL_USE_CASES = [
  {
    ...
    icon: <Gift className="h-5 w-5 text-amber-700" />
  },
  {
  ...
  },
  {
    ...
    icon: <PlayCircle className="h-5 w-5 text-amber-700" />
  },
  {
    ...
    icon: <Music2 className="h-5 w-5 text-amber-700" />
  },
  {
      ...
      <main className="min-h-screen bg-gradient-to-b from-purple-50 to-white py-8 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Button asChild variant="ghost" className="mb-4 text-amber-700 hover:text-amber-800 hover:bg-purple-50">
              <Link href="/fonts">
              ...
              <CardContent className="p-6 md:p-8">
                <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
                  ...
                  <div className="w-full md:w-2/3">
                    <span className="text-xs text-amber-700 font-medium px-2 py-1 bg-purple-50 rounded-full mb-2 inline-block">Playful Display</span>
                    <h1 className="text-4xl md:text-5xl font-bold text-amber-800 mt-1 mb-3">Marhey Font</h1>
            ...
            <div className="prose prose-purple max-w-none">
              <h2 id="distinctive-features" className="text-3xl font-bold text-amber-800 mt-12 mb-6">Distinctive Features of Marhey</h2>
              ...
              <h2 id="alphabet-showcase" className="text-3xl font-bold text-amber-800 mt-12 mb-6">Marhey Showcase: Words of Joy</h2>
              <Card className="border-purple-200 mb-12 bg-white">
                <CardHeader>
                  <CardTitle className="text-xl text-amber-800">Lively & Unconventional Letterforms</CardTitle>
                  <CardDescription className="text-amber-700">Observe the playful, energetic, and distinctive style of Marhey.</CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-amber-700 mt-4 text-center">Marhey brings a burst of energy and fun to every letter.</p>
                </CardContent>
              </Card>

              <h2 id="text-examples" className="text-3xl font-bold text-amber-800 mt-12 mb-6">Marhey in Action: Playful Examples</h2>
              ...
              <h2 id="use-cases" className="text-3xl font-bold text-amber-800 mt-12 mb-6">Ideal Use Cases for Marhey</h2>
              ...
              <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center items-center p-6 bg-purple-50 rounded-lg border border-purple-200">
                 <h3 className="text-2xl font-semibold text-amber-800 text-center sm:text-left">Unleash the Fun with Marhey!</h3>
                <Button asChild size="lg" className="bg-purple-600 hover:bg-purple-700 text-white">
