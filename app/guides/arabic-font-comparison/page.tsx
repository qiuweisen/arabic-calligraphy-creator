                ...
                <div className="prose max-w-none">
                    ...
                    <table className="w-full border border-gray-200 rounded-lg">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="text-center py-4 px-6 font-semibold text-amber-700">Cairo (Modern)</th>
                          <th className="text-center py-4 px-6 font-semibold text-amber-700">Amiri (Traditional)</th>
                          <th className="text-center py-4 px-6 font-semibold text-gray-600">Winner</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-200">
                        <tr>
                          ...
                          <td className="py-4 px-6 text-center">
                            <div className="flex items-center justify-center">
                              ...
                              <span className="text-amber-700 font-semibold">Good</span>
                            </div>
                          </td>
                          <td className="py-4 px-6 text-center">
                            <span className="bg-blue-100 text-amber-800 px-2 py-1 rounded text-sm font-medium">Cairo</span>
                          </td>
                        </tr>
                        ...
                        <tr className="bg-gray-50">
                          ...
                          <td className="py-4 px-6 text-center">
                            <div className="flex items-center justify-center">
                              <CheckCircle className="h-5 w-5 text-emerald-600 mr-2" />
                              <span className="text-emerald-600 font-semibold">Small</span>
                            </div>
                          </td>
                          <td className="py-4 px-6 text-center">
                            <div className="flex items-center justify-center">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mt-8">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                      <h4 className="font-semibold text-amber-800 mb-4">🏆 Cairo Wins When:</h4>
              ...
              <CardContent className="space-y-6">
                <div className="prose max-w-none">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                      <h4 className="font-semibold text-amber-800 mb-4">Tajawal</h4>
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-bold text-emerald-600">9.0/10</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span>Readability</span>
                          <span className="font-bold text-amber-700">8.5/10</span>
                        </div>
                        <div className="flex justify-between text-sm">
                    ...
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                      <h4 className="font-semibold text-amber-800 mb-4">Mada</h4>
                      <div className="space-y-3">
                        <div className="flex justify-between text-sm">
                          <span>Modern Appeal</span>
                          <span className="font-bold text-emerald-600">9.0/10</span>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                      <h4 className="font-semibold text-emerald-600 mb-4">Cairo</h4>
                      <div className="space-y-3">
                        <div className="flex justify-between text-sm">
                          <span>Modern Appeal</span>
                          <span className="font-bold text-amber-700">8.5/10</span>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                    <h4 className="font-semibold text-gray-900 mb-4">🎯 Recommendation Matrix</h4>
                    <div className="grid md:grid-cols-3 gap-6">
                      <div>
                        <h5 className="font-semibold text-gray-600 mb-2">Choose Tajawal if:</h5>
                      ...
                      <div>
                        <h5 className="font-semibold text-gray-600 mb-2">Choose Mada if:</h5>
                        <ul className="text-sm text-gray-600 space-y-1">
                      ...
                      <div>
                        <h5 className="font-semibold text-gray-600 mb-2">Choose Cairo if:</h5>
                        <ul className="text-sm text-gray-600 space-y-1">
            ...
            <Card className="border-emerald-200 shadow-lg">
              ...
              <CardContent className="space-y-6">
                <div className="prose max-w-none">
                    ...
                    <table className="w-full border border-gray-200 rounded-lg">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="text-center py-3 px-4 font-semibold text-gray-600">File Size</th>
                          <th className="text-center py-3 px-4 font-semibold text-gray-600">Load Time</th>
                          <th className="text-center py-3 px-4 font-semibold text-gray-600">Rendering</th>
                          <th className="text-center py-3 px-4 font-semibold text-gray-600">Mobile</th>
                      ...
                      <tbody className="divide-y divide-gray-200">
                        <tr>
                          ...
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs">45KB</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs">Fast</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs">Excellent</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs">Optimized</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs font-bold">A+</span>
                          </td>
                        </tr>
                        <tr className="bg-gray-50">
                          <td className="py-3 px-4 font-medium">Tajawal</td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs">52KB</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs">Fast</span>
                          </td>
                          ...
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs">Good</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs font-bold">A</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="py-3 px-4 text-center">
                            <span className="bg-red-100 text-red-600 px-2 py-1 rounded text-xs">180KB</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs">Medium</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs">Excellent</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs">Fair</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs font-bold">B+</span>
                          </td>
                        </tr>
                        <tr className="bg-gray-50">
                          <td className="py-3 px-4 font-medium">Mada</td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs">58KB</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-green-100 text-emerald-600 px-2 py-1 rounded text-xs">Fast</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs">95KB</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs">Medium</span>
                          </td>
                          ...
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs">Good</span>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <span className="bg-yellow-100 text-amber-800 px-2 py-1 rounded text-xs font-bold">B+</span>
                          </td>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mt-8">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                      <h4 className="font-semibold text-amber-800 mb-4">🚀 Performance Tips</h4>
                      <ul className="text-sm text-amber-700 space-y-2">
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                      <h4 className="font-semibold text-emerald-600 mb-4">📱 Mobile Optimization</h4>
              ...
              <CardContent className="space-y-6">
                <div className="prose max-w-none">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                      <h4 className="font-semibold text-amber-800 mb-4">📱 Mobile Apps</h4>
                      <div className="space-y-3">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                      <h4 className="font-semibold text-amber-800 mb-4">🌐 Websites</h4>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-sm">Cairo</span>
                          <div className="flex">
