...
const TOOL_SLUG = "arabic-signature-generator"
const TOOL_NAME = "Arabic Signature Generator"
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.arabicSignatureGenerator.meta" })
...
export default async function ArabicSignatureGeneratorPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
  const { locale } = await params
  const t = await getTranslations({ locale, namespace: "tools.arabicSignatureGenerator" })
  ...
  const styleGalleryItems = t.raw("styleGallery.items") as Array<{ title: string; description: string }>
  const useCaseItems = t.raw("useCases.items") as Array<{ title: string; description: string }>
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
        ...
        <section id="calligraphy-tool-section" className="container mx-auto px-4 pb-12">
          <ToolGeneratorClient initialFont="Aref Ruqaa" />
        </section>

        <section className="container mx-auto px-4 pb-12">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-amber-800 mb-4">{t("styleGallery.title")}</h2>
            <div className="grid gap-4 md:grid-cols-3">
              {styleGalleryItems.map((item) => (
        ...
        <section className="container mx-auto px-4 pb-12">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-amber-800 mb-4">{t("useCases.title")}</h2>
            <div className="grid gap-4 md:grid-cols-3">
        ...
        <section className="container mx-auto px-4 pb-12">
          <div className="max-w-3xl mx-auto bg-white border border-amber-100 rounded-xl p-6 md:p-8">
            <h2 className="text-2xl font-bold text-amber-800 mb-4">{t("guidelines.title")}</h2>
